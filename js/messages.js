var messages = {
  ...
  labelFooter: {
    en: "Flexbox Hamster is created by",
    he: "Flexbox Hamster נוצר על ידי",
    ro: "Flexbox Hamster este creat de",
    sr: "Flexbox Hamster је направио",
    bs: "Flexbox Hamster je napravio",
    bg: "Flexbox Hamster е създадена от",
    de: "Flexbox Hamster wurde gemacht von",
    fr: "Flexbox Hamster est créé par",
    "pt-br": "Flexbox Hamster foi criado por",
    es: "Flexbox Hamster es una creación de",
    ru: "Игра Flexbox Hamster создана",
    fa: "قورباغه فلکس باکس ساخته شده توسط",
    "zh-cn": "Flexbox Hamster的作者是",
    "zh-tw": "Flexbox Hamster的作者是",
    tr: "Flexbox Hamster'nin yaratıcısı:",
    it: "Flexbox Hamster è stato creato da",
    ko: "Flexbox Hamster는 다음에 의해 개발되었습니다",
    lt: "Flexbox Hamster kūrėjas",
    vi: "Flexbox Hamster được tạo ra bởi",
    pl: "Flexbox Hamster jest wytworem",
    cs: "Flexbox Hamster vytvořil",
    ja: "Flexbox Hamster is created by",
    hu: "A Flexbox Hamster-t készítette",
    eo: "Flexbox Hamster far",
    sv: "Flexbox Hamster skapades av",
    uk: "Гру Flexbox Hamster створено",
    hi: "Flexbox Hamster के निर्माणकर्ता ",
    nl: "Flexbox Hamster is gemaakt door",
    ta: "Flexbox Hamster உருவாக்கியவர்",
    te: "Flexbox Hamster చేసిన వారు",
    ml: "Flexbox Hamster സൃഷ്ടിച്ചത്",
    el: "Το Flexbox Hamster δημιουργήθηκε από",
    mk: "Flexbox Hamster е создадено од",
    lv: "Flexbox Hamster autori ir",
    id: "Flexbox Hamster dibuat oleh",
    ar: "تم انشاء فروغي فلكسبكس بواسطة",
    ca: "Flexbox Hamster és una creació de",
    da: "Flexbox Hamster er skabt af",
    et: "Flexbox Hamster on looja on",
    fi: "Flexbox Hamstern on tehnyt",
    gl: "Flexbox Hamster creouno",
    th: "Flexbox Hamster ถูกสร้างโดย",
    mn: "Flexbox Hamster is created by",
  },
  labelLevel: {
    en: "Level",
    he: "שלב",
  ...
  title: {
    en: "Flexbox Hamster - A game for learning CSS flexbox",
    he: "Flexbox Hamster - משחק ללמידת CSS flexbox",
    ro: "Flexbox Hamster - Un joc pentru a învăța CSS flexbox",
    sr: "Flexbox Hamster - Игра за учење CSS flexbox-а",
    bs: "Flexbox Hamster - Igra za učenje CSS flexbox-a",
    bg: "Flexbox Hamster - Игра за учене на CSS flexbox",
    de: "Flexbox Hamster - Ein Spiel, um CSS flexbox zu lernen",
    fr: "Flexbox Hamster - Un jeu pour apprendre les flexbox CSS",
    "pt-br": "Flexbox Hamster - Um jogo para aprender CSS flexbox",
    es: "Flexbox Hamster - Un juego para aprender CSS flexbox",
    ru: "Flexbox Hamster - игра для изучения CSS flexbox",
    fa: "قورباغه فلکس باکس - یک بازی جذاب برای آموزش سی اس اس فلکس باکس",
    "zh-cn": "Flexbox Hamster - 一个用来学CSS flexbox的游戏",
    "zh-tw": "Flexbox Hamster - 一個用來學CSS flexbox的遊戲",
    tr: "Flexbox Hamster - CSS flexbox için öğretici oyun",
    it: "Flexbox Hamster - Un gioco per imparare CSS flexbox",
    ko: "Flexbox Hamster - CSS flexbox 속성 배우기 게임",
    lt: 'Flexbox Hamster - Žaidimas padėsiantis perprasti CSS "flexbox" metodiką',
    vi: "Flexbox Hamster - Một trò chơi để học CSS flexbox",
    pl: 'Flexbox Hamster - Gra wprowadzająca do CSS flexbox"',
    cs: "Flexbox Hamster - CSS flexbox hrou",
    ja: "Flexbox Hamster - CSS flexbox学習ゲーム",
    hu: "Flexbox Hamster - Játékos CSS flexbox tanulás",
    eo: "Flexbox Hamster - Ludo por lerni CSS flexbox-on",
    sv: "Flexbox Hamster - Ett spel för att lära sig CSS flexbox",
    uk: "Flexbox Hamster - гра для вивчення CSS flexbox",
    hi: "Flexbox Hamster - CSS Flexbox सीखने के लिए एक खेल",
    nl: "Flexbox Hamster - Een spel om CSS flexbox te leren",
    ta: "Flexbox Hamster - CSS flexbox கற்றல் விளையாட்டு",
    te: "Flexbox Hamster - CSS Flexbox నేర్చుకోవడానికి ఒక ఆట",
    ml: "Flexbox Hamster - CSS Flexbox പഠിക്കാം",
    el: "Flexbox Hamster - Ένα παιχνίδι για την εκμάθηση του CSS Flexbox",
    mk: "Flexbox Hamster - Игра за учење на CSS flexbox",
    lv: "Flexbox Hamster - Spēle, kas Tev palīdzēs iemācīties CSS Flexbox",
    id: "Flexbox Hamster - Sebuah permainan untuk belajar CSS flexbox",
    ar: "فروغي فلكسبكس - لعبة لتعلم الفلكسبكس في CSS",
    ca: "Flexbox Hamster - Un joc per aprendre CSS Flexbox",
    da: "Flexbox Hamster - Et spil, der lærer dig CSS Flexbox",
    et: "Flexbox Hamster - Mäng CSS flexbox'i õppimiseks",
    fi: "Flexbox Hamster - Peli, jossa opit CSS flexbox -asettelun",
    gl: "Flexbox Hamster - Un xogo para aprenderes CSS Flexbox",
    th: "Flexbox Hamster - เกมสำหรับเรียนรู้ CSS Flexbox",
    mn: "Flexbox Hamster - CSS flexbox-г сурах тоглоом",
  },
  labelReset: {
    en: "Reset",
    he: "איפוס",
